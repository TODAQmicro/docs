...
Now create your commodity with the Twin ID and DQ (you can create multiple commodities with the same Twin ID):
...
**Congratulations!** You've successfully created a commodity. Save the **hash** value as you'll need it for the payment element in step 5.
